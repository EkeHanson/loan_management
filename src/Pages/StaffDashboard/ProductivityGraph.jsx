        ...
        <div className="insights-content">
          <div className="insight">
            ...
            <div>
              ...
              <p>Your highest task completion was on {data.labels[data.completed.indexOf(Math.max(...data.completed))]}</p>
            </div>
          </div>
          <div className="insight">
            ...
            <div>
              <h4>Pending Tasks</h4>
              <p>You have an average of {Math.round(pendingTasks / data.labels.length)} pending tasks per day</p>
            </div>
          </div>
        </div>
      </div>
